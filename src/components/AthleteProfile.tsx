              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <h1 className="text-white">{athlete.name}</h1>
                    {athlete.verified && (
                      <CheckCircle2 className="h-6 w-6 text-white" />
                    )}
                  </div>
                  <p className="text-white/90 text-xl">{athlete.position}</p>
                </div>
                <div className="flex gap-2">
                  ...
                  >
                    ...
                    {loading ? 'Aguarde...' : isFollowing ? 'Seguindo' : 'Seguir'}
                  </Button>
              ...
              <div className="grid grid-cols-3 gap-4">
                <Card>
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-2xl">{(athlete.followers || 0).toLocaleString('pt-BR')}</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-4 text-center">
                    <p className="text-muted-foreground text-sm">Idade</p>
                    <p className="text-2xl">{athlete.age || '-'}</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-4 text-center">
                    <p className="text-muted-foreground text-sm">Altura</p>
                    <p className="text-2xl">{formatHeight(athlete.height)}</p>
                  </CardContent>
                </Card>
              </div>
            </div>
